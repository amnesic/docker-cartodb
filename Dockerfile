...
# added, to convert to profuction mode
...
# adding this line to enable access to database, as per https://github.com/glaroc/docker-cartodb-https/commit/b304ca068b6904e527deea48b003f3875eed3e75
